"""
Django settings for simpl-blackjack-ui project.
...
ROOT_URLCONF = 'simpl_blackjack_ui.urls'
...
WSGI_APPLICATION = 'simpl_blackjack_ui.wsgi.application'
...
ROOT_TOPIC = 'world.simpl.sims.simpl-blackjack'

GAME_SLUG = 'simpl-blackjack'
